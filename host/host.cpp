...
int main(int argc, char* argv[])
{
   ...
   int status;
    ...
    puf = clCreateBuffer(context,  CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX,  sizeof(int) * number_of_words, &mem_ext, NULL);
    ...
    err |= clEnqueueReadBuffer( commands, puf, CL_TRUE, 0, sizeof(int) * number_of_words, h_puf_output, 0, NULL, &readevent );
